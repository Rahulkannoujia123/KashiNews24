...
export async function fetchFreshStories(category = '') {
  try {
    ...
    // Never fall back to unrelated stories when a category was explicitly requested.
    return category
...
export const navItems = ['Home', 'Varanasi', 'Kashi', 'Crime', 'Politics', 'Traffic', 'Education', 'Jobs', 'Business', 'Sports', 'Weather', 'Events'];
